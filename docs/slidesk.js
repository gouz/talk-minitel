    ...
    window.slidesk = {
      ...
      slides: [],
      animationTimer: 300,
      onSlideChange: function() {;window.slidesk.autonext();;window.slidesk.prepareSteps();;window.slidesk.progressActive();;;window.slidesk.sbs();;;;;window.slidesk.checkSlide();;;window.slidesk.slides[window.slidesk.currentSlide].querySelectorAll(".reload").forEach((i) => {i.setAttribute("src", i.getAttribute("src"));});},
      env: {"PLUGINS":"keyboard-notes, autonext, steps, progress","MINITEL_IP":"192.168.0.100","HOST_IP":"http://192.168.0.101:1337/public","WEBCAM":"JOYACCESS JA-Webcam"},
      cwd: '/Users/sylvaingougouzian/Talks/minitel/',
      lastAction: ""
    };
